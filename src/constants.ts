...
export const LIVE_PROVIDER_URL = import.meta.env.VITE_LIVE_PROVIDER_URL ?? 'http://localhost:3000';
export const TOKEN_KEY = import.meta.env.VITE_TOKEN_KEY ?? 'token';
export const REFRESH_TOKEN_KEY = import.meta.env.VITE_REFRESH_TOKEN_KEY ?? 'refresh-token';
export const TOKEN_EXPIRES_AT_KEY = import.meta.env.VITE_TOKEN_EXPIRES_AT_KEY ?? 'token-expires';
